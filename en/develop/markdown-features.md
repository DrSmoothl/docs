...
This page follows the [documentation writing conventions](https://github.com/MaiM-with-u/MaiBot/blob/main/docs/CONTRIBUTE.md): **content pages must not use Markdown tables**. Use lists or definition-style descriptions instead.
