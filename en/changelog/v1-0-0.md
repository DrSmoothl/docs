...
<div class="release-lead">
  <div>
    <strong>More natural conversations</strong>
    <span>Maisaka observes the context, judges the right moment, picks tools, then writes the reply.</span>
  </div>
  <div>
    <strong>More reliable memory</strong>
    <span>A_Memorix manages long-term memory, evidence, persona profiles, and knowledge sources in one place.</span>
  </div>
  <div>
    <strong>More complete WebUI</strong>
    <span>The Dashboard becomes a unified workbench for configuration, management, monitoring, and troubleshooting.</span>
  </div>
</div>
...
- [Login & Settings](../manual/webui/index.md)
