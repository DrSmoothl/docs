...
```python
@Tool("greet",
      description="向用户打招呼",  # 推荐使用 description 作为主描述字段
      # 弃用：SDK 2.4.0+ 推荐使用 description，brief_description 和 detailed_description 已弃用
...
class SearchPlugin(MaiBotPlugin):
    ...
    @Tool(
        "search_web",
        description="搜索互联网获取信息",  # 推荐使用 description 作为主描述字段
        # 弃用：SDK 2.4.0+ 推荐使用 description，brief_description 和 detailed_description 已弃用
    ...
    @Tool(
        "get_weather",
        description="获取指定城市的天气信息",  # 推荐使用 description 作为主描述字段
        # 弃用：SDK 2.4.0+ 推荐使用 description，brief_description 已弃用
        parameters=[
            ToolParameterInfo(
                name="city",
                param_type=ToolParamType.STRING,
